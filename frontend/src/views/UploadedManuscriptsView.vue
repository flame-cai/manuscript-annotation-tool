...
<template>
  ...
  <form v-if="manuscripts.length && models.length" class="mb-3" @submit.prevent="fetch_manuscript">
    <label for="page" class="form-label">Manuscript</label>
    <select v-model="manuscript_name" class="form-select" id="page" placeholder="Select a manuscript">
      <option
    ...
    <select class="form-select" id="model" v-model="model" placeholder="Select a model">
